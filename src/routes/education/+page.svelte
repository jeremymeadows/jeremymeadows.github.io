<article>
  ...
  <section>
    <div class="collapse collapse-indicator">
      <label class="collapse-title">
        <input type="checkbox" />
        <h2>
          Dundalk Institute of Technology<!-- <span>Dundalk, Co Louth, Ireland</span> -->
        </h2>
        <h3>
          BSc in Computing<span>September 2022 - May 2025</span>
        </h3>
      </label>
      <div class="collapse-content">
        <p>
          After working in industry for about a year-and-a-half, I decided that
          ...
          after graduation if I don't decide to move back to the US.
        </p>
        <p>
          While my Baylor education was almost exclusively software development
  ...
  <section>
    <div class="collapse">
      <label class="collapse-title">
        <input type="checkbox" />
        <h2>
          Baylor University<!-- <span>Waco, Texas, USA</span> -->
        </h2>
        <h3>
          Computer Science Degree Program<span>August 2017 - December 2020</span>
        </h3>
      </label>
      <div class="collapse-content">
        <p>
          At Baylor, I studied computer science and competed in Cross Country
        ...
        <p>
          While I definitely learned a lot in the classes, the professors never
          ...
          regardless of my experience on the matter.
        </p>
      </div>
    </div>
  </section>
